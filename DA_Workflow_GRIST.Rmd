...
- Who has been awarded the most grants for that 'search term'?
...
top_x_PIs(CRISPR,10,end_date_cutoff="2016-01-01")
...
total_running_money_top_x_PIs <- function(input_tb, x_to_keep = length(input_tb),
  ...
  ggplot(top_x_amount)+
    ...
    geom_point(aes(x=Values,y=Amount, col=Name))+
    geom_step(aes(x=Values, y=Amount, col=Name))
)
