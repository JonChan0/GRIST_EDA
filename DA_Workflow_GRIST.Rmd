...
file_trial <- read_tsv(str_c("./output_tsv/",filenames[2]), 
                     col_names = c("ID","Name","Institution","Start Date","End Date","Title","Abstract", "Funder",                                         "Grant Type","Amount"), 
                     col_types = "iccDDccccc",
                     na="None")

for (i in seq_along(filenames)){
  file <- str_extract(filenames[i],".+\\.")
  file1 <- read_tsv(str_c("./output_tsv/",filenames[i]), 
                     col_names = c("ID","Name","Institution","Start Date","End Date","Title","Abstract", "Funder",                                         "Grant Type","Amount"), 
                     col_types = "iccDDccccc",
                     na="None")
}
